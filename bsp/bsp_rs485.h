...
//接收使能
 //官总板子
#define    RS485_RECV_ENABLE(index)  GPIO_ResetBits(BSP_RS485Table[index].RD.Port, BSP_RS485Table[index].RD.Pin)     //RE=1
//发送使能
#define    RS485_SEND_ENABLE(index)    GPIO_SetBits(BSP_RS485Table[index].RD.Port, BSP_RS485Table[index].RD.Pin)   //RE=0
...
//新板子
//#define    RS485_SEND_ENABLE(index)  GPIO_ResetBits(BSP_RS485Table[index].RD.Port, BSP_RS485Table[index].RD.Pin)     //RE=1
////发送使能
//#define    RS485_RECV_ENABLE(index)    GPIO_SetBits(BSP_RS485Table[index].RD.Port, BSP_RS485Table[index].RD.Pin)   //RE=0
/* Private typedef----------------------------------------------------------------------------*/
//接收/发送使能，只能二选一
typedef enum
{
