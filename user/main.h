...
#define PRI_MODULE_PRIOD		12		//模块周期性任务

#define PRI_PCU_CONTROL			  15	//PCU主函数
#define PRI_PCU_MAIN			  10	//PCU主函数
#define PRI_MODULE_RECV			  16	//PCU主函数
#define PRI_MODULE_SEND			  17	//PCU主函数
