	...
	switch(*keyval)
    {
		 ...
		 case LCD_KEY4:		//Vin启动,临时在这里直接发
			 	if(SYSSet.NetState == DISP_NET)
				{
					...
					if((SYSSet.NetYXSelct == XY_AP)  || (SYSSet.NetYXSelct == XY_YKC)||(SYSSet.NetYXSelct == XY_TT)|| (SYSSet.NetYXSelct == XY_YL3)|| (SYSSet.NetYXSelct == XY_YL4)|| (SYSSet.NetYXSelct == XY_XJ)||(SYSSet.NetYXSelct == XY_YL1)) 
					{
		...
		case LCD_KEY5:		//Vin启动,临时在这里直接发
			 	if(SYSSet.NetState == DISP_NET)
				{
					...
					if((SYSSet.NetYXSelct == XY_AP)  || (SYSSet.NetYXSelct == XY_YKC)||(SYSSet.NetYXSelct == XY_TT)|| (SYSSet.NetYXSelct == XY_YL3)|| (SYSSet.NetYXSelct == XY_YL4))
					{
						Net_StartCharge(GUN_B,MODE_VIN);
						Set_VIN_Success(GUN_B,VIN_IDLE);
						Net_StartCharge(GUN_A,MODE_VIN);
						Set_VIN_Success(GUN_A,VIN_IDLE);
...
void HYKeyEvent81(_LCD_KEYVALUE *keyval)
{
    ...
    switch(*keyval)
    {
		case LCD_KEY4: //A枪按键
			keynum = 0;
			keynum1 = 0;
			if((SYSSet.NetYXSelct == XY_AP) || (SYSSet.NetYXSelct == XY_HY)||(SYSSet.NetYXSelct == XY_TT)||(SYSSet.NetYXSelct == XY_TT)||  (SYSSet.NetYXSelct == XY_JG)||  (SYSSet.NetYXSelct == XY_YL2)|| (SYSSet.NetYXSelct == XY_YKC)|| (SYSSet.NetYXSelct == XY_YL3)|| (SYSSet.NetYXSelct == XY_YL4)|| (SYSSet.NetYXSelct == XY_XJ)||(SYSSet.NetYXSelct == XY_YL1)) 
			{
			//枪连接而且空闲
				if((pdisp_conrtol->NetGunState[GUN_A] == GUN_IDLE )&& (GetGunState(GUN_A) == GUN_CONNECTED)) 
				{
        ...
        case LCD_KEY5: //B枪按键
			keynum = 0;
			keynum1 = 0;
			if((SYSSet.NetYXSelct == XY_AP) || (SYSSet.NetYXSelct == XY_HY)||  (SYSSet.NetYXSelct == XY_JG)||  (SYSSet.NetYXSelct == XY_TT)||   (SYSSet.NetYXSelct == XY_YL2) || (SYSSet.NetYXSelct == XY_YKC)|| (SYSSet.NetYXSelct == XY_YL3)|| (SYSSet.NetYXSelct == XY_YL4)|| (SYSSet.NetYXSelct == XY_XJ)||(SYSSet.NetYXSelct == XY_YL1)) 
			{
				//枪连接而且空闲
				if((pdisp_conrtol->NetGunState[GUN_B] == GUN_IDLE )&& (GetGunState(GUN_B) == GUN_CONNECTED)) 
				{
