...
_SHOW_STATUS ShowStatus[SHOW_MAX] = 
{
  ...
  //{SHOW_ENDFAIL_LEAKOUTTIMEOUT,		"泄放回路故障",					12},   //和下面这个一样主要是针对禹航电气屏蔽
	{SHOW_ENDFAIL_LEAKOUTTIMEOUT,		"正常停止 ",				    8},    //F26和下面这个一样主要是针对禹航电气屏蔽
	{SHOW_ENDFAIL_CHARGEMODULEERR,		"正常停止",						8},	   //F20（20240411 模块故障 修改 正常停止：主要是针对他们）单独电气的模块故障---屏蔽掉--修改成：-正常模块
	{SHOW_ENDFAIL_MODULEERR,			"正常停止",						8},	   //F9（20240411 模块故障 修改 正常停止：主要是针对他们）单独电气的模块故障---屏蔽掉--修改成：-正常模块
	...
	//{SHOW_STOP_HANDERR,            		"充电枪故障",					10},    //E18
	{SHOW_STOP_HANDERR,            		"正常停止",					8},    //E18----充电枪故障修改成正常停止
	...
	//{SHOW_STOP_OUTVOLTVORE ,       		"输出电压异常",					12},   //禹航单独，输入电压异常不显示
	{SHOW_STOP_OUTVOLTVORE ,       		"正常停止",					8},   //禹航单独，输入电压异常不显示----显示正常停止
  ...
  //{SHOW_STOP_MATERFAIL ,       		"电表故障",						 8},    //（20240411 电表故障 修改 正常停止：主要是针对他们）	
	{SHOW_STOP_MATERFAIL ,       		"正常停止",						 8},    //（20240411 电表故障 修改 正常停止：主要是针对他们）
	...
	{SHOW_SYS_IDFAIL ,          	"CMP ID故障",				10},
	{SHOW_GUN_NOTUSER ,          	"接触器粘连",				10},
	{SHOW_PDU_SINGNAL ,          	"PDU通信超时",				11},
